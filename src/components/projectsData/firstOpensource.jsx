  ...
  retrospective: [
    {
      ...
      content: '복잡한 프레임워크가 아닌 순수 HTML/CSS/JS로 이루어진 레포지토리였기에, 제가 가진 웹의 기본기를 발휘하여 원인을 짚어낼 수 있었습니다. 며칠간 코드를 뜯어보고 다양한 시도를 반복하며 결국 정답을 찾아낸 과정은 제 안의 집요함을 증명해 준 시간이었습니다.'
    },
    {
      title: '진짜 개발자의 소통 방식',
